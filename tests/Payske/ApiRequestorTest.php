...
use Payske\HttpClient\CurlClient;

/**
 * @internal
 * @covers \Payske\ApiRequestor
 */
final class ApiRequestorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $reflector = new \ReflectionClass(\Payske\ApiRequestor::class);
    ...
    public function testDefaultHeaders()
    {
        ...
        Payske::setAppInfo('MyTestApp', '1.2.34', 'https://mytestapp.example', 'partner_1234');
        $apiKey = 'sk_test_notarealkey';
        $clientInfo = ['httplib' => 'testlib 0.1.2'];

        $headers = $method->invoke(null, $apiKey, $clientInfo);

        $ua = \json_decode($headers['X-Payske-Client-User-Agent']);
        ...
        static::assertSame(
            $headers['User-Agent'],
            'Payske/v1 PhpBindings/' . Payske::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)'
        );
    ...
    public function testRaisesInvalidRequestErrorOn400()
    {
        ...
        try {
            ...
            static::assertSame('id', $e->getPayskeParam());
        } catch (\Exception $e) {
    ...
    public function testRaisesCardErrorOn402()
    {
        ...
        try {
            ...
            static::assertSame('card_declined', $e->getPayskeCode());
            static::assertSame('generic_decline', $e->getDeclineCode());
            static::assertSame('exp_month', $e->getPayskeParam());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthInvalidRequestError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_request', $e->getPayskeCode());
    ...
    public function testRaisesOAuthInvalidClientError()
    {
        ...
        try {
            ...
            static::assertSame(401, $e->getHttpStatus());
            static::assertSame('invalid_client', $e->getPayskeCode());
    ...
    public function testRaisesOAuthInvalidGrantError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_grant', $e->getPayskeCode());
    ...
    public function testRaisesOAuthInvalidScopeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_scope', $e->getPayskeCode());
    ...
    public function testRaisesOAuthUnsupportedGrantTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_grant_type', $e->getPayskeCode());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthUnsupportedResponseTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_response_type', $e->getPayskeCode());
    ...
    public function testHeaderPayskeVersionGlobal()
    {
        Payske::setApiVersion('2222-22-22');
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
            [],
            [
                'Payske-Version: 2222-22-22',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderPayskeVersionRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
        ...
        Charge::create([], ['Payske_version' => '2222-22-22']);
    }

    public function testHeaderPayskeAccountGlobal()
    {
        Payske::setAccountId('acct_123');
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
            [],
            [
                'Payske-Account: acct_123',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderPayskeAccountRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
        ...
        Charge::create([], ['Payske_account' => 'acct_123']);
    }
