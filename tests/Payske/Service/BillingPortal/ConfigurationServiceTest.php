...
/**
 * @internal
 * @covers \Payske\Service\BillingPortal\ConfigurationService
 */
final class ConfigurationServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Payske\BillingPortal\Configuration::class, $resource);
    }
    ...
    public function testList()
    {
        ...
        static::assertInstanceOf(\Payske\BillingPortal\Configuration::class, $resource->data[0]);
    }
}
