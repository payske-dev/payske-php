...
/**
 * @internal
 * @covers \Payske\Service\CustomerService
 */
final class CustomerServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Payske\Customer::class, $resources->data[0]);
    }
    ...
    public function testAllBalanceTransactions()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\CustomerBalanceTransaction::class, $resources->data[0]);
    }
    ...
    public function testAllSources()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\AlipayAccount::class, $resources->data[0]);
    }
    ...
    public function testAllTaxIds()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\TaxId::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Payske\Customer::class, $resource);
    }
    ...
    public function testCreateBalanceTransaction()
    {
        ...
        static::assertInstanceOf(\Payske\CustomerBalanceTransaction::class, $resource);
    }
