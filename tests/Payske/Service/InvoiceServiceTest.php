...
/**
 * @internal
 * @covers \Payske\Service\InvoiceService
 */
final class InvoiceServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAll()
    {
        ...
        static::assertInstanceOf(\Payske\Invoice::class, $resources->data[0]);
    }
    ...
    public function testCreate()
    {
        ...
        static::assertInstanceOf(\Payske\Invoice::class, $resource);
    }
    ...
    public function testUpcomingLines()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\InvoiceLineItem::class, $resources->data[0]);
    }
