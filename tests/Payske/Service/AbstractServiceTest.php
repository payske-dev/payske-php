...
/**
 * @internal
 * @covers \Payske\Service\AbstractService
 */
final class AbstractServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUpMockService()
    {
        ...
        $this->service = new \Payske\Service\CouponService($this->client);
    }
    ...
    {
        $this->formatParamsReflector = new \ReflectionMethod(\Payske\Service\AbstractService::class, 'formatParams');
        $this->formatParamsReflector->setAccessible(true);
    }

    public function testNullGetsEmptyStringified()
    {
        $this->expectException(\Payske\Exception\InvalidRequestException::class);
