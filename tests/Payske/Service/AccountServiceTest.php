...
/**
 * @internal
 * @covers \Payske\Service\AccountService
 */
final class AccountServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testAllCapabilities()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\Capability::class, $resources->data[0]);
    }
    ...
    public function testAllExternalAccounts()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\BankAccount::class, $resources->data[0]);
    }
    ...
    public function testAllPersons()
    {
        ...
        static::assertInternalType('array', $resources->data);
        static::assertInstanceOf(\Payske\Person::class, $resources->data[0]);
    }
