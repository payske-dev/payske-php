 ...
 * @coversNothing
 */
final class PayskeTelemetryTest extends \PHPUnit\Framework\TestCase
{
    use TestHelper;
    ...
    public function testNoTelemetrySentIfNotEnabled()
    {
        ...
        Charge::all();
        static::assertArrayNotHasKey('X-Payske-Client-Telemetry', $requestheaders);
    ...
    {
        Payske::setEnableTelemetry(true);
        ...
        Charge::all();
        static::assertArrayHasKey('X-Payske-Client-Telemetry', $requestheaders);

        $data = \json_decode($requestheaders['X-Payske-Client-Telemetry'], true);
