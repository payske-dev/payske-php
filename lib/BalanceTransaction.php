...
/**
 * Balance transactions represent funds moving through your Payske account. They're
 * created for every type of transaction that comes into or flows out of your
 * Payske account balance.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/reports/balance-transaction-types">Balance
 * Transaction Types</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Gross amount of the transaction, in %s.
 * @property int $available_on The date the transaction's net funds will become available in the Payske balance.
...
class BalanceTransaction extends ApiResource
{
    ...
    const TYPE_Payske_FEE = 'Payske_fee';
    const TYPE_Payske_FX_FEE = 'Payske_fx_fee';
