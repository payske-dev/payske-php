 ...
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/billing/subscriptions/subscription-schedules">Subscription
 * Schedules</a>.
 *
 ...
 * @property null|\Payske\PayskeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Payske\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Payske\PayskeObject $default_settings
 ...
 * @property \Payske\PayskeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\Payske\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \Payske\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\SubscriptionSchedule the released subscription schedule
     */
