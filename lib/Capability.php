...
/**
 * This is an object representing a capability for a Payske account.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/connect/account-capabilities">Account
 * capabilities</a>.
 *
 * @property string $id The identifier for the capability.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\Payske\Account $account The account for which the capability enables functionality.
