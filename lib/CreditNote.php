 ...
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/billing/invoices/credit-notes">Credit Notes</a>.
 *
 ...
 * @property string|\Payske\Customer $customer ID of the customer.
 * @property null|string|\Payske\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \Payske\PayskeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\Payske\Invoice $invoice ID of the invoice.
 * @property \Payske\Collection $lines Line items that make up the credit note
 ...
 * @property null|int $out_of_band_amount Amount that was credited outside of Payske.
 ...
 * @property null|string|\Payske\Refund $refund Refund related to this credit note.
 * @property string $status Status of this credit note, one of <code>issued</code> or <code>void</code>. Learn more about <a href="https://docs.payske.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
 ...
 * @property \Payske\PayskeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \Payske\CreditNote the previewed credit note
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\CreditNote the voided credit note
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of credit note line items
     */
