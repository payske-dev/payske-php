 ...
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/payments/save-during-payment">Save a card during
 * payment</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Payske\PayskeObject $address The customer's address.
 * @property int $balance Current balance, if any, being stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that will be added to their next invoice. The balance does not refer to any unpaid invoices; it solely takes into account amounts that have yet to be successfully applied to any invoice. This balance is only taken into account as invoices are finalized.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://docs.payske.com/docs/currencies">ISO code for the currency</a> the customer can be charged in for recurring billing purposes.
 * @property null|string|\Payske\Account|\Payske\AlipayAccount|\Payske\BankAccount|\Payske\BitcoinReceiver|\Payske\Card|\Payske\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://docs.payske.com/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\Payske\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \Payske\PayskeObject $invoice_settings
 ...
 * @property null|\Payske\PayskeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \Payske\Collection $sources The customer's payment sources, if any.
 * @property \Payske\Collection $subscriptions The customer's current subscriptions, if any.
 * @property \Payske\PayskeObject $tax
 ...
 * @property \Payske\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \Payske\Customer the updated customer
     */
     ...
     *
     * @return \Payske\Collection the list of customer balance transactions
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\CustomerBalanceTransaction
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\AlipayAccount|\Payske\BankAccount|\Payske\BitcoinReceiver|\Payske\Card|\Payske\Source
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of tax ids
     */
