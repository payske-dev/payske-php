...
/**
 * A <code>Transfer</code> object is created when you move funds between Payske
 * accounts as part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a Payske
 * account to a card or bank account. This behavior has since been split out into a
 * <a href="https://docs.payske.com/docs/api#payout_object">Payout</a> object, with
 * corresponding payout endpoints. For more information, read about the <a
 * href="https://docs.payske.com/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/connect/charges-transfers">Creating Separate
 ...
 * @property null|string|\Payske\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Payske\Account $destination ID of the Payske account the transfer was sent to.
 * @property string|\Payske\Charge $destination_payment If the destination is a Payske account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Payske\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Payske\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \Payske\Transfer the canceled transfer
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of transfer reversals
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\TransferReversal
     */
