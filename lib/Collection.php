 ...
 */
class Collection extends PayskeObject implements \Countable, \IteratorAggregate
{
    ...
    /**
     * @return \Generator|PayskeObject[] A generator that can be used to
     ...
     *
     * @return null|\Payske\PayskeObject
     */
