...
class Payske
{
    /** @var string The Payske API key to be used for requests. */
    public static $apiKey;

    /** @var string The Payske client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the Payske API. */
    public static $apiBase = 'https://api.payske.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = '';

    /** @var string The base URL for the Payske API uploads endpoint. */
    public static $apiUploadBase = '';

    /** @var null|string The version of the Payske API to use for requests. */
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Payske API */
    ...
    /**
     * @return string | null The Payske account ID for connected account
     *   requests
     */
    ...
    /**
     * @param string $accountId the Payske account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Payske API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Payske as an HTTP Header
     * with the current request. This enables Payske to do latency and metrics analysis without adding extra
