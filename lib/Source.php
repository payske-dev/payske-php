 ...
 * They represent a customer's payment instrument, and can be used with the Payske
 * API just like a <code>Card</code> object: once chargeable, they can be charged,
 * or can be attached to customers.
 *
 * Related guides: <a href="https://docs.payske.com/docs/sources">Sources API</a> and <a
 * href="https://docs.payske.com/docs/sources/customers">Sources &amp; Customers</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property \Payske\PayskeObject $ach_credit_transfer
 * @property \Payske\PayskeObject $ach_debit
 ...
 * @property \Payske\PayskeObject $code_verification
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://docs.payske.com/docs/currencies">ISO code for the currency</a> associated with the source. This is the currency for which the source will be chargeable once ready. Required for <code>single_use</code> sources.
 ...
 * @property \Payske\PayskeObject $klarna
 ...
 * @property \Payske\PayskeObject $multibanco
 * @property null|\Payske\PayskeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \Payske\PayskeObject $p24
 * @property \Payske\PayskeObject $receiver
 * @property \Payske\PayskeObject $redirect
 * @property \Payske\PayskeObject $sepa_credit_transfer
 * @property \Payske\PayskeObject $sepa_debit
 * @property \Payske\PayskeObject $sofort
 * @property \Payske\PayskeObject $source_order
 ...
 * @property \Payske\PayskeObject $three_d_secure
 ...
 * @property \Payske\PayskeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \Payske\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Source the detached source
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of source transactions
     */
    public function sourceTransactions($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/source_transactions';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = \Payske\Util\Util::convertToPayskeObject($response, $opts);
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Source the verified source
     */
