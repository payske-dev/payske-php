 ...
 * @property PayskeObject $source The source object for errors returned on a
 ...
 */
class ErrorObject extends PayskeObject
{
    /**
     * Possible string representations of an error's code.
     *
     * @see https://docs.payske.com/docs/error-codes
     */
