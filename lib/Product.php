 ...
 * conjunction with <a href="https://docs.payske.com/docs/api#prices">Prices</a> to
 ...
 * href="https://docs.payske.com/docs/payments/checkout/client#create-products">one-time
 ...
 * @property null|\Payske\PayskeObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\Payske\TaxCode $tax_code A <a href="https://docs.payske.com/docs/tax/tax-codes">tax code</a> ID.
 ...
 * @property null|string $unit_label A label that represents units of this product in Payske and on customers’ receipts and invoices. When set, this will be included in associated invoice line item descriptions.
