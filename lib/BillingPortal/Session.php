...
/**
 * The Billing customer portal is a Payske-hosted UI for subscription and billing
 * management.
 *
 ...
 *
 * Learn more in the <a
 * href="https://docs.payske.com/docs/billing/subscriptions/customer-portal">product
 * overview</a> and <a
 * href="https://docs.payske.com/docs/billing/subscriptions/integrating-customer-portal">integration
 * guide</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\Payske\BillingPortal\Configuration $configuration The configuration used by this session, describing the features available.
