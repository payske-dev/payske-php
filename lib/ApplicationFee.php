 ...
 * @property string|\Payske\Account $account ID of the Payske account this fee was taken from.
 ...
 * @property string|\Payske\PayskeObject $application ID of the Connect application that earned the fee.
 * @property null|string|\Payske\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this collected application fee on your account balance (not including refunds).
 * @property string|\Payske\Charge $charge ID of the charge that the application fee was taken from.
 ...
 * @property null|string|\Payske\Charge $originating_transaction ID of the corresponding charge on the platform account, if this fee was the result of a charge using the <code>destination</code> parameter.
 ...
 * @property \Payske\Collection $refunds A list of refunds that have been applied to the fee.
 */
class ApplicationFee extends ApiResource
{
     ...
     *
     * @return \Payske\Collection the list of fee refunds
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\ApplicationFeeRefund
     */
