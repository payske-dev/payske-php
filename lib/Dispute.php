 ...
 * documentation.
 *
 * Related guide: <a href="https://docs.payske.com/docs/disputes">Disputes and
 * Fraud</a>.
 *
 ...
 * @property \Payske\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Payske account as a result of this dispute.
 * @property string|\Payske\Charge $charge ID of the charge that was disputed.
 ...
 * @property \Payske\PayskeObject $evidence
 * @property \Payske\PayskeObject $evidence_details
 * @property bool $is_charge_refundable If true, it is still possible to refund the disputed payment. Once the payment has been fully refunded, no further funds will be withdrawn from your Payske account as a result of this dispute.
 ...
 * @property null|string|\Payske\PaymentIntent $payment_intent ID of the PaymentIntent that was disputed.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Payske\Dispute the closed dispute
     */
