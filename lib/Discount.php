 ...
 * @property \Payske\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\Payske\Customer $customer The ID of the customer associated with this discount.
 ...
 */
class Discount extends PayskeObject
{
