...
/**
 * If you have <a href="https://docs.payske.com/docs/sigma/scheduled-queries">scheduled
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your Payske data at this time.
 * @property \Payske\PayskeObject $error
 * @property null|\Payske\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Payske\ApiResource
{
