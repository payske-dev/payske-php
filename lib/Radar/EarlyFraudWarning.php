 ...
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/disputes/measuring#early-fraud-warnings">Early
 * Fraud Warnings</a>.
 *
 ...
 * @property string|\Payske\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property string|\Payske\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \Payske\ApiResource
{
