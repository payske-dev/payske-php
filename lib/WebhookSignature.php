...
abstract class WebhookSignature
{
    ...
    /**
     * Verifies the signature header sent by Payske. Throws an
     * Exception\SignatureVerificationException exception if the verification fails for
     * any reason.
     *
     * @param string $payload the payload sent by Payske
     ...
     *
     * The current scheme used by Payske ("v1") is HMAC/SHA-256.
     *
