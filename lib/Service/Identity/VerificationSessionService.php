...
class VerificationSessionService extends \Payske\Service\AbstractService
{
    /**
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Identity\VerificationSession
     */
    ...
    /**
     * Redact a VerificationSession to remove all collected information from Payske.
     ...
     *
     * Redaction is irreversible. Redacted objects are still accessible in the Payske
