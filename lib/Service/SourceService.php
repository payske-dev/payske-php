...
class SourceService extends \Payske\Service\AbstractService
{
    /**
     * @param string $id
     ...
     * creation request and Payske will return the corresponding up-to-date source
     * object information.
     *
     * @param string $id
     * @param null|array $params
