...
class WebhookEndpointService extends \Payske\Service\AbstractService
{
    /**
     ...
     * href="https://dashboard.payske.com/account/webhooks">webhooks settings</a>
     ...
     * href="https://dashboard.payske.com/account/webhooks">webhook endpoint
     * management</a> page of the Payske dashboard.
     *
     * @param string $id
     * @param null|array $params
     * @param null|array|\Payske\Util\RequestOptions $opts
