...
class CouponService extends \Payske\Service\AbstractService
{
    /**
     ...
     * href="https://dashboard.payske.com/coupons">coupon management</a> page of the
     * Payske dashboard. Coupon creation is also accessible via the API if you need to
     ...
     * href="https://dashboard.payske.com/coupons">coupon management</a> page of the
     * Payske dashboard. However, deleting a coupon does not affect any customers who
