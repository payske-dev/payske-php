...
class CreditNoteService extends \Payske\Service\AbstractService
{
    /**
     ...
     * <li>Outside of Payske credit: record the amount that is or will be credited
     * outside of Payske (using <code>out_of_band_amount</code>).</li> </ul>
     *
     * For post-payment credit notes the sum of the refund, credit and outside of
     * Payske amounts must equal the credit note total.
     *
