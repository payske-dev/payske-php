...
class PaymentMethodService extends \Payske\Service\AbstractService
{
    /**
     ...
     * href="/docs/Payske-js/reference#Payske-create-payment-method">Payske.js
     * reference</a> to learn how to create PaymentMethods via Payske.js.
     *
