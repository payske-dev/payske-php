...
class SubscriptionItemService extends \Payske\Service\AbstractService
{
    /**
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\SubscriptionItem
     */
     ...
     * with a quantity.
     *
     * Usage records provide <code>quantity</code> information that Payske uses to
     * track how much a customer is using your service. With usage information and the
     * pricing model set up by the <a
     * href="https://docs.payske.com/docs/billing/subscriptions/metered-billing">metered
     * billing</a> plan, Payske helps you send accurate invoices to your customers.
     *
     ...
     * there is more than one usage record with the same timestamp, Payske adds the
     ...
     * href="https://docs.payske.com/docs/billing/subscriptions/tiers">tiered pricing</a>
     * model.
     *
     * @param string $parentId
     * @param null|array $params
