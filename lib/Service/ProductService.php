...
class ProductService extends \Payske\Service\AbstractService
{
    /**
     ...
     * either a product creation request or the product list, and Payske will return
