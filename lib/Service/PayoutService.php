...
class PayoutService extends \Payske\Service\AbstractService
{
    /**
     * Returns a list of existing payouts sent to third-party bank accounts or that
     * Payske has sent you. The payouts are returned in sorted order, with the most
     ...
     * href="#balance">Payske balance</a> must be able to cover the payout amount, or
     ...
     *
     * If you are creating a manual payout on a Payske account that uses multiple
     ...
     * either a payout creation request or the payout list, and Payske will return the
