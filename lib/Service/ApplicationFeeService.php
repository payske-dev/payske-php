...
class ApplicationFeeService extends \Payske\Service\AbstractService
{
    /**
     ...
     * refunded. Funds will be refunded to the Payske account from which the fee was
