...
class PaymentIntentService extends \Payske\Service\AbstractService
{
    /**
     ...
     * href="/docs/Payske-js/reference#Payske-handle-card-payment">client SDKs</a> and
