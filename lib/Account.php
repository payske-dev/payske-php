...
/**
 * This is an object representing a Payske account. You can retrieve it to see
 * properties on the account like its current e-mail address or if the account is
 * enabled yet to make live charges.
 *
 * Some properties, marked below, are available only to platforms that want to <a
 * href="https://docs.payske.com/docs/connect/accounts">create and manage Express or
 * Custom accounts</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Payske\PayskeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \Payske\PayskeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \Payske\PayskeObject $company
 * @property \Payske\PayskeObject $controller
 * @property string $country The account's country.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://docs.payske.com/docs/payouts">Payske supports in the account's country</a>.
 ...
 * @property bool $payouts_enabled Whether Payske can send payouts to this account.
 * @property \Payske\PayskeObject $requirements
 * @property null|\Payske\PayskeObject $settings Options for customizing how the account functions within Payske.
 * @property \Payske\PayskeObject $tos_acceptance
 * @property string $type The Payske account type. Can be <code>standard</code>, <code>express</code>, or <code>custom</code>.
 */
class Account extends ApiResource
{
    ...
    private function serializeAdditionalOwners($legalEntity, $additionalOwners)
    {
        ...
        foreach ($additionalOwners as $i => $v) {
            $update = ($v instanceof PayskeObject) ? $v->serializeParameters() : $v;
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of persons
     */
    public function persons($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/persons';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = Util\Util::convertToPayskeObject($response, $opts);
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Account the rejected account
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of capabilities
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\Collection the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \Payske\Exception\ApiErrorException if the request fails
     *
     * @return \Payske\BankAccount|\Payske\Card
     */
