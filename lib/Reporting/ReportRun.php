 ...
 * specific run parameters. Once the object is created, Payske begins processing
 ...
 * href="https://docs.payske.com/docs/reporting/statements/api">API Access to
 * Reports</a>.
 *
 ...
 * @property \Payske\PayskeObject $parameters
 * @property string $report_type The ID of the <a href="https://docs.payske.com/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\Payske\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Payske\ApiResource
{
