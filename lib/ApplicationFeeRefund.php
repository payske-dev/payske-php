 ...
 * refunded to the Payske account from which the fee was originally collected.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/connect/destination-charges#refunding-app-fee">Refunding
 * Application Fees</a>.
 *
 ...
 * @property string|\Payske\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Payske refund
     */
