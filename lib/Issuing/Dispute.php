...
/**
 * As a <a href="https://docs.payske.com/docs/issuing">card issuer</a>, you can dispute
 * transactions that the cardholder does not recognize, suspects to be fraudulent,
 * or has other issues with.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/issuing/purchases/disputes">Disputing
 * Transactions</a>
 *
 ...
 * @property null|\Payske\BalanceTransaction[] $balance_transactions List of balance transactions associated with the dispute.
 ...
 * @property string|\Payske\Issuing\Transaction $transaction The transaction being disputed.
 */
class Dispute extends \Payske\ApiResource
{
     ...
     *
     * @return \Payske\Dispute the submited dispute
     */
