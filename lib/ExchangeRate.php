...
/**
 * <code>Exchange Rate</code> objects allow you to determine the rates that Payske
 ...
 * Please refer to our <a href="https://docs.payske.com/docs/exchange-rates">Exchange
 ...
 * @property \Payske\PayskeObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
