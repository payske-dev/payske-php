...
/**
 * This is an object representing a person associated with a Payske account.
 *
 ...
 * account. See the <a
 * href="https://docs.payske.com/docs/connect/standard-accounts">Standard onboarding</a>
 * or <a href="https://docs.payske.com/docs/connect/express-accounts">Express onboarding
 * documentation</a> for information about platform pre-filling and account
 * onboarding steps.
 *
 * Related guide: <a
 * href="https://docs.payske.com/docs/connect/identity-verification-api#person-information">Handling
 ...
 * @property null|\Payske\PayskeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Payske\PayskeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Payske\PayskeObject $dob
 ...
 * @property null|\Payske\PayskeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Payske\PayskeObject $relationship
 * @property null|\Payske\PayskeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Payske\PayskeObject $verification
 */
class Person extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Payske account reversal
     */
